        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Automation is deterministic in v1:</span> Same input always produces 
              same variants. All transformations use rule-based phrase maps and deterministic truncation/expansion—no freeform AI.
            </p>
          </div>
        </div>
      </div>
