  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="px-6 pb-6 relative">
        ...
        <div className="flex items-start justify-between -mt-20 mb-4 flex-wrap gap-4">
          <div className="flex items-end gap-6 flex-wrap">
            {/* Circular Avatar */}
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white bg-white shadow-xl overflow-hidden flex-shrink-0">
              {headshotImageUrl ? (
                <Image
                ...
                <div className="w-full h-full bg-gradient-to-br from-gray-400 to-gray-600 flex items-center justify-center">
                  <span className="text-3xl md:text-5xl font-semibold text-white">{initials}</span>
                </div>
              )}
            </div>
