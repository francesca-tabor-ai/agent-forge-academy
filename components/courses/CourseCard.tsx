...
export function CourseCard({ course, metadata, enrollment }: CourseCardProps) {
  ...
  return (
    <Link
      ...
      className="block bg-white border border-gray-200 rounded-lg p-6 hover:border-brand-light hover:shadow-lg transition-all h-full"
    >
