...
-- Create question context type enum
...
CREATE INDEX idx_questions_student_profile_id ON questions(student_profile_id);
CREATE INDEX idx_questions_context ON questions(context_type, context_id);
