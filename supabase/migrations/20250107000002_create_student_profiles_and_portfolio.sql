...
CREATE INDEX idx_student_profiles_profile_id ON student_profiles(profile_id);
CREATE INDEX idx_student_profiles_visibility ON student_profiles(visibility);
CREATE INDEX idx_portfolio_projects_student_profile_id ON portfolio_projects(student_profile_id);
CREATE INDEX idx_portfolio_projects_visibility ON portfolio_projects(visibility);
