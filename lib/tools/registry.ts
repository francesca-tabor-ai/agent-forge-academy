...
export const toolsRegistry: Tool[] = [
  ...
  {
    id: 'autonomous-governance-office',
    name: 'The Autonomous Governance Office',
    description: 'Automate the monitoring of AI models for performance and ethical compliance. Manage hundreds of active AI agents simultaneously with real-time monitoring, compliance tracking, and automated governance workflows. Demonstrates how the AI Acceleration Office can scale governance operations across large-scale AI deployments.',
    href: '/student/tools/autonomous-governance-office',
    status: 'active',
    tags: ['governance', 'monitoring', 'compliance', 'ethics', 'ai-agents', 'automation', 'performance', 'risk-management', 'multi-agent', 'observability'],
    recommendedFor: ['public-sector-governance', 'agentic-systems', 'trust-and-regulation'],
    category: 'Public Sector Governance',
    difficultyLevel: 'advanced',
    duration: '~6-10 hours',
    industries: ['Government', 'Public Sector', 'Enterprise Software', 'Financial Services', 'Healthcare'],
    bestFor: ['AI Governance Officer', 'Compliance Manager', 'Tech Lead', 'PM', 'Architect', 'Risk Manager'],
  },
  {
    id: 'ai-portfolio-prioritizer',
    name: 'AI Portfolio Prioritizer',
    description: 'Analyze a list of business problems and rank them by ROI and feasibility. Demonstrate how AI can accelerate the decision-making process for project funding.',
    href: '/student/tools/ai-portfolio-prioritizer',
    status: 'active',
    tags: ['prioritization', 'roi', 'feasibility', 'portfolio', 'decision-making', 'funding', 'analysis', 'strategy', 'business-problems'],
    recommendedFor: ['ai-native-go-to-market-systems', 'platform-os'],
    category: 'GTM & Revenue Operations',
    difficultyLevel: 'intermediate',
    duration: '~2-4 hours',
    industries: ['SaaS', 'B2B Sales / RevOps', 'Enterprise Software', 'Startups'],
    bestFor: ['PM', 'Founder', 'Product Manager', 'Business Analyst', 'Executive'],
  },
];
