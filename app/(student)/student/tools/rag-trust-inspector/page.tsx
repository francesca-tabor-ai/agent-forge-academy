...
export default async function RAGTrustInspectorPage() {
  ...
  const tool = getToolById('rag-trust-inspector');
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl font-bold text-gray-900">{tool?.name || 'RAG Trust Inspector'}</h1>
        ...
        <p className="text-gray-600 mt-2">
          {tool?.description || 'Inspect and validate RAG (Retrieval-Augmented Generation) systems for trust, accuracy, and reliability.'}
        </p>
      </div>
