...
export default async function DecisionTradeoffSimulatorPage() {
  ...
  const tool = getToolById('decision-tradeoff-simulator');
    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl font-bold text-gray-900">{tool?.name || 'Decision Trade-off Simulator'}</h1>
        ...
        <p className="text-gray-600 mt-2">
          {tool?.description || 'Simulate and analyze trade-offs in decision-making processes. Evaluate different architectural and strategic choices.'}
        </p>
      </div>
