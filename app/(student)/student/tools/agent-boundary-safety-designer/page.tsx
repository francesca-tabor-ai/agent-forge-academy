...
import { AgentBoundarySafetyDesignerClient } from '@/components/tools/agent-boundary-safety-designer/AgentBoundarySafetyDesignerClient';
...
export default async function AgentBoundarySafetyDesignerPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {studentProfileId && (
        <AgentBoundarySafetyDesignerClient 
          toolId={tool?.id || 'agent-boundary-safety-designer'}
