...
import { AIPortfolioPrioritizerClient } from '@/components/tools/ai-portfolio-prioritizer/AIPortfolioPrioritizerClient';

export default async function AIPortfolioPrioritizerPage() {
  ...
  const tool = getToolById('ai-portfolio-prioritizer');
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-3xl font-bold text-gray-900">
            {tool?.name || 'AI Portfolio Prioritizer'}
          </h1>
      ...
      <AIPortfolioPrioritizerClient
        toolId={tool?.id || 'ai-portfolio-prioritizer'}
